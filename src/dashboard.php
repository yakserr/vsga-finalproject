    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="sidebar-sticky pt-3">
                    <ul class="nav flex-column">
                        <div class="menu-sidebar p-2 ">
                            <li class="nav-item ">
                                <a class="nav-link active d-flex " href="dashboard.php">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 pt-2">
                ...
                <div class="jumbotron">
                    <h1 class="display-4">Hellow!</h1>
                    <p class="lead">Ini adalah dashboard aplikasi Perpus sederhana.</p>
                    <hr class="my-4">
                    <p>Aplikasi ini digunakan untuk melengkapi Tugas akhir program VSGA - AMIKOM JWD A</p>
                    <a class="btn btn-primary btn-lg" href="https://github.com/yakserr/vsga-finalproject" target="_blank" role="button">
