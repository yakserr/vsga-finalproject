            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse shadow pt-2">
                ...
                <div class="sidebar-sticky pt-3">
                    ...
                    <ul class="nav flex-column mb-2 ">
                        ...
                        <div class="menu-sidebar p-2 ">
                            <li class="nav-item">
                                <a class="nav-link  d-flex" href="../returns/returns.php">
                                    <div class="icon align-middle">
                    ...
                    <ul class="nav flex-column">
                        <div class="menu-sidebar p-2 ">
                            <li class="nav-item">
                                <a class="nav-link active d-flex" href="../reports/reports.php">
                                    <div class="icon align-middle">
                    ...
                    <div class="greetings">
                        <div class="nav bread-crumb">
                            <ol class="list-unstyled d-flex justify-content-center">
                                ...
                                <li class="mr-1">/</li>
                                <li class="mr-1 align-bottom">
                                    <a href="borrows.php" class="text-decoration-none">Report Transaksi</a>
                                </li>
                            </ol>
                        </div>
                        <h3 class="font-weight-bolder">Report Transaksi</h3>
                    </div>
                </div>
                                ...
                                <div>
                                    <div class="mb-4">
                                        <div class="header-table d-flex justify-content-between">
                                            <h4 class="card-title">Detail Report Transaksi</h4>
                                        </div>
                                        <p class="text-muted">Detail Report Transaksi</p>
                                                ...
                                                <tbody>
                                                    <?php foreach ($transactions as $key => $transaction) : ?>
                                                        <tr class="text-nowrap">
                                                            ...
                                                            <td><?= strlen($transaction['judul']) > 50 ? substr($transaction['judul'], 0, 50) . "..." : $transaction['judul']; ?></td>
