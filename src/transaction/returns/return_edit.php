...
<body>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse shadow pt-2">
                ...
                <div class="sidebar-sticky pt-3">
                    ...
                    <ul class="nav flex-column mb-2 ">
                        ...
                        <div class="menu-sidebar p-2 ">
                            <li class="nav-item">
                                <a class="nav-link active d-flex" href="returns.php">
                                    <div class="icon align-middle">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control submit" id="anggota" name="anggota" value="<?= $transaction['nama'] ?>" disabled>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="buku">Buku</label>
                                                            <input type="text" class="form-control submit" id="buku" name="buku" value="<?= $transaction['judul'] ?>" disabled>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    <label for="pinjam">Tgl Pinjam</label>
                                                                    <input type="date" name="pinjam" class="form-control" id="pinjam" onchange="returnDate()" value="<?= $transaction['tgl_pinjam'] ?>" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="kembali" class="form-control border border-success" id="kembali" value="<?= $transaction['tgl_kembali'] ?> " disabled>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    <label for="tgl_kembali_asli">Tgl Kembali Asli</label>
                                                                    <input type="date" name="tgl_kembali_asli" class="form-control" id="tgl_kembali_asli" onchange="lateDate()" value="<?= $transaction['tgl_kembali_asli'] ?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    if ($interval->format('%R%a') > 0) {
                                                                        ...
                                                                        $telat = $interval->format('%a');
                                                                    }

                                                                    ?>
                                                                    <input type="text" name="telat" class="form-control border border-success" id="telat" value="<?= $telat ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row justify-content-end">
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control border border-success" id="denda" value="<?= $telat * 2000 ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script>
        ...
        function lateDate() {
            const borrowDate = document.getElementById("kembali").value;
            const returnDate = document.getElementById("tgl_kembali_asli").value;
            ...
            if (diffDays < 0) {
                ...
                telat.value = diffDays;
                denda.value = diffDays * 2000;
            }
        }
    </script>
</body>
