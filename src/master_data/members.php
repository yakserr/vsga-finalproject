                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            ...
                            <<<<<<< HEAD <a class="sidebar-link waves-effect waves-dark sidebar-link m-2" href="books.php" aria-expanded="false">
                                =======
                                <a class="sidebar-link waves-effect waves-dark sidebar-link m-2" href="#" aria-expanded="false">
                                    >>>>>>> ecafc76548be78625fd347a74bf8dce68f13b58a
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-return-right" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M1.5 1.5A.5.5 0 0 0 1 2v4.8a2.5 2.5 0 0 0 2.5 2.5h9.793l-3.347 3.346a.5.5 0 0 0 .708.708l4.2-4.2a.5.5 0 0 0 0-.708l-4-4a.5.5 0 0 0-.708.708L13.293 8.3H3.5A1.5 1.5 0 0 1 2 6.8V2a.5.5 0 0 0-.5-.5z" />
                                    </svg>
                                    <span class="hide-menu">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                                ...
                                <li class="active" aria-current="page">
                                    ...
                                    <span class="align-middle text-primary"><a href="members.php">Members</a></span>
                                </li>
                            </ol>
                        </nav>
                        <h1 class="mb-0 fw-bold">Data Members</h1>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-md-flex">
                                    <div>
                                        ...
                                        <h5 class="card-subtitle">Overview of data members</h5>
                                    </div>
                                    <div class="ms-auto">
                                        <div class="dl">
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0 table-hover align-middle text-nowrap">
                                        <thead>
                                            <tr>
                                                <th class="border-top-0 fw-bolder">Member Code</th>
                                                <th class="border-top-0 fw-bolder">Name</th>
                                                <th class="border-top-0 fw-bolder">Email</th>
                                                <th class="border-top-0 fw-bolder">Phone</th>
                                                <th class="border-top-0 fw-bolder">Address</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach ($members as $member) { ?>
                                                <tr>
                                                    <td>
                                                        <h4 class="m-b-0 font-16"><?= $member['member_code'] ?></h4>
                                                    </td>
                                                    <td>
                                                        <div class="align-items-center">
                                                            <div class="">
                                                                <h4 class="m-b-0"><?= $member['name'] ?></h4>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><label class="badge bg-success font-16"><?= $member['email'] ?></label></td>
                                                    <td><?= $member['phone'] ?></td>
                                                    <td>
                                                        <?= $member['address'] ?>
                                                    </td>
                                    ...
                                    <nav aria-label="justify-content-center">
                                        <ul class="pagination">
                                            <<<<<<< HEAD <li class="page-item"><a class="page-link" href="?page=<?= $prev ?>">Previous</a></li>
